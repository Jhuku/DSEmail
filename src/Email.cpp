...
main()
{
	...
	if (file.good()) {
			// Read the file and load into array
									...
									do{
											...
											if(ch_inbox==1)
												...
												else if(ch_inbox==5)
												{
													...
													cout<<"\n GROUP MESSAGE\n";
													cout<<"-------------------";
													cout<<"\nEnter the number of users whome you want to send the message: ";
													cin>>msg_n;
													...
													obj.store_sent(group_message,login_name);
